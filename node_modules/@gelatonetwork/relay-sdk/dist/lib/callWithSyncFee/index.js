...
const relayWithSyncFee = (payload, config) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        return yield (0, utils_1.post)({
            ...
            request: Object.assign(Object.assign(Object.assign({}, request), { isRelayContext: (_a = request.isRelayContext) !== null && _a !== void 0 ? _a : true }), options),
        }, config);
    }
    catch (error) {
