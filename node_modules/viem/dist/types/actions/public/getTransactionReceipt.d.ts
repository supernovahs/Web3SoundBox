 ...
 * })
 */
export declare function getTransactionReceipt<TChain extends Chain | undefined>(client: PublicClient<Transport, TChain>, { hash }: GetTransactionReceiptParameters): Promise<import("../../types/formatter.js").ExtractFormatterReturnType<TChain, "transactionReceipt", import("../../index.js").TransactionReceipt>>;
