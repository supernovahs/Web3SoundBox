 ...
 */
export declare function verifyMessage<TChain extends Chain | undefined>(client: PublicClient<Transport, TChain>, { address, message, signature, ...callRequest }: VerifyMessageParameters): Promise<VerifyMessageReturnType>;
