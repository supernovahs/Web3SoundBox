...
export interface Create_call extends BaseContract {
    ...
    filters: {
        "ContractCreation(address)"(newContract?: PromiseOrValue<string> | null): ContractCreationEventFilter;
        ContractCreation(newContract?: PromiseOrValue<string> | null): ContractCreationEventFilter;
    };
    estimateGas: {
        performCreate(value: PromiseOrValue<BigNumberish>, deploymentData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
