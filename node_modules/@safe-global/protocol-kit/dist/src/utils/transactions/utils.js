...
async function standardizeSafeTransactionData({ safeContract, predictedSafe, ethAdapter, tx, contractNetworks }) {
    ...
    let safeVersion;
    if (predictedSafe) {
        safeVersion = ((_e = predictedSafe === null || predictedSafe === void 0 ? void 0 : predictedSafe.safeDeploymentConfig) === null || _e === void 0 ? void 0 : _e.safeVersion) || config_1.DEFAULT_SAFE_VERSION;
    }
    else {
        if (!safeContract) {
